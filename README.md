...
***Внимание! Если вы не установите некоторые пакеты, например typescript, то ничего работать не будет тк наш проект предполагает установку всех этих библиотек для корретной работы.***
...
- outDir: Эта опция указывает, в какую папку должны быть выведены скомпилированные файлы. В данном случае, в папку ./dist.
